...
// (ACF Field Group "Banner Sản phẩm" đã được chuyển vào inc/acf/shop-banner-fields.php)
...
/**
 * ------------------------------------------------------------------------
 * TỰ ĐỘNG NẠP CÁC SHORTCODE MODULE (TRANG CHỦ & CÁC TRANG KHÁC)
 * ------------------------------------------------------------------------
 */
if (is_dir(__DIR__ . '/shortcodes')) {
...
if (is_dir(__DIR__ . '/inc/acf')) {
    foreach (glob(__DIR__ . '/inc/acf/*.php') as $file) {
        require_once $file;
    }
}
