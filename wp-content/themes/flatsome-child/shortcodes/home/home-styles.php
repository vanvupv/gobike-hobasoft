    ...
    <style id="gobike-custom-css">
        ...
        *::after {
        ...
        @media (max-width: 849px) {
            ...
            /* ==========================================================================
               KHỐI VIDEO SLIDER CHUẨN ẢNH 2 (VIDEO REVIEW THỰC TẾ & TRẢI NGHIỆM THẬT)
               ========================================================================== */
            ...
            .gvr-slider-container,
            .gev-slider-container {
                position: relative !important;
                width: 100% !important;
            }
            ...
            /* Khung Thumbnail tỉ lệ 16:9 với góc bo tròn 12px */
            .gvr-thumb-box {
                position: relative !important;
                width: 100% !important;
            ...
            .gvr-card:hover .gvr-thumb-img {
                transform: scale(1.05) !important;
            }

            /* Dải chữ nổi góc trên Thumbnail */
            .gvr-thumb-overlay {
                position: absolute !important;
                top: 0 !important;
                left: 0 !important;
            ...
            .gvr-card:hover .gvr-play-circle {
                transform: translate(-50%, -50%) scale(1.12) !important;
                background: rgba(13, 110, 46, 0.9) !important;
            ...
            /* Nút Next / Prev Swiper tròn trắng nổi trên slider (Chuẩn Ảnh 2) */
            .gvr-swiper-arrow {
                position: absolute !important;
                top: 40% !important;
            ...
            .gvr-swiper-arrow:hover {
                background: #0d6e2e !important;
                color: #ffffff !important;
                border-color: #0d6e2e !important;
                box-shadow: 0 6px 18px rgba(13, 110, 46, 0.35) !important;
            }
            ...
            .gvr-swiper-pagination,
            .gev-swiper-pagination {
                display: none !important;
                justify-content: center !important;
                gap: 6px !important;
                position: absolute !important;
            ...
            .gvr-swiper-pagination .swiper-pagination-bullet,
            .gev-swiper-pagination .swiper-pagination-bullet {
                width: 7px !important;
            ...
            .gvr-swiper-pagination .swiper-pagination-bullet-active,
            .gev-swiper-pagination .swiper-pagination-bullet-active {
            ...
            /* Lightbox Modal Popup phát YouTube */
            .gvr-video-modal {
                position: fixed !important;
                top: 0 !important;
                left: 0 !important;
