...
| **07** | **Hero Banner & Slider Trang Chủ** (Chuẩn mẫu 3 cột) | [sc-hero-banner.php](file:///e:/1.%20D%E1%BB%B0%20%C3%81N%20TH%E1%BB%B0C%20T%E1%BA%BE%20(2026)/(17)%20GOBIKE%20(28082026)/wp-content/themes/flatsome-child/shortcodes/home/sc-hero-banner.php) | `[gobike_home_hero_banner]`<br>`[gobike_banner_home]` | `news_limit`: số lượng tin tức hiển thị ở cột phải (mặc định 3)<br>*(Bố cục 3 cột chuẩn thiết kế: Banner dọc Chất lượng thật bên trái, Slider chính + 4 dịch vụ cam kết ở giữa, Tin tức mới nhất + Banner showroom bên phải)* |
