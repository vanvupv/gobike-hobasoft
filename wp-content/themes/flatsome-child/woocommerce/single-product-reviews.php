...
<div id="reviews" class="woocommerce-Reviews row">
	<div id="comments" class="col large-<?php if ( get_comment_pages_count() == 0 || $tab_style == 'sections' || $tab_style == 'tabs_vertical' ) { echo '12'; } else { echo '7'; } ?>">
		...
		<?php if ( have_comments() ) : ?>
			...
			?>
		<?php else : ?>
			<p class="woocommerce-noreviews"><?php esc_html_e( 'Không có đánh giá nào.', 'woocommerce' ); ?></p>
		<?php endif; ?>
	</div>
		...
		<div id="review_form_wrapper" class="large-<?php if ( get_comment_pages_count() == 0 || $tab_style == 'sections' || $tab_style == 'tabs_vertical' ) { echo '12'; } else { echo '5'; } ?> col">
			<div id="review_form" class="col-inner">
				...
				$comment_form = array(
					...
					'title_reply'          => have_comments() ? esc_html__( 'Add a review', 'woocommerce' ) : sprintf( esc_html__( 'Hãy là người đầu tiên đánh giá sản phẩm &ldquo;%s&rdquo;', 'woocommerce' ), get_the_title() ),
					/* translators: %s is product title */
					...
					'comment_notes_after'  => '',
					'label_submit'         => esc_html__( 'Đánh giá', 'woocommerce' ),
					'logged_in_as'         => '',
					'comment_field'        => '',
				);
