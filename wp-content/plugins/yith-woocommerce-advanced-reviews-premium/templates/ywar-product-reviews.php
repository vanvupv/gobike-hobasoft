...
<div id="reviews" class="ywar-review-content">
    ...
    <div id="comments">
        <h2><?php
            if ( get_option ( 'woocommerce_enable_review_rating' ) === 'yes' && $reviews_count ) {
                printf ( _n ( 'Có %s đánh giá cho sản phẩm %s', 'Có %s đánh giá cho sản phẩm %s', $reviews_count, 'yith-woocommerce-advanced-reviews' ), $reviews_count, get_the_title () );
            } else {
        ...
        <?php else : ?>
            ...
            <p class="woocommerce-noreviews"><?php _e ( 'Sản phẩm chưa có đánh giá nào.', 'yith-woocommerce-advanced-reviews' ); ?></p>
    ...
    <div
        ...
        <div id="review_form">
            ...
            $comment_form = array (
                'title_reply'          => $reviews_count ? '<span class="review_label">' . esc_html__( 'Thêm đánh giá', 'yith-woocommerce-advanced-reviews' ) . '</span>' : esc_html__( 'Hãy là người đánh giá đầu tiên cho sản phẩm', 'yith-woocommerce-advanced-reviews' ) . ' &ldquo;' . get_the_title () . '&rdquo;',
                ...
                'label_submit'         => esc_html__( 'Gửi đánh giá', 'yith-woocommerce-advanced-reviews' ),
                'logged_in_as'         => '',
                'comment_field'        => '',
            );

            $comment_form[ 'comment_field' ] .= '<p class="comment-form-comment"><label for="comment">' . esc_html__( 'Đánh giá của bạn', 'yith-woocommerce-advanced-reviews' ) . '</label><textarea id="comment" name="comment" cols="45" rows="8" aria-required="true"></textarea></p>';
