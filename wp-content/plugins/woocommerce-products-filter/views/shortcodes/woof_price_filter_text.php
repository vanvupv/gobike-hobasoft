...
<div class="woof_price_filter_txt_container">
	<label class="woof_wcga_label_hide"  for="<?php echo esc_attr( $price_id ); ?>_from"><?php echo esc_html( $min_price_txt ); ?></label>
	...
	<label class="woof_wcga_label_hide"  for="<?php echo esc_attr( $price_id ); ?>_to"><?php echo esc_html( $max_price_txt ); ?></label>
