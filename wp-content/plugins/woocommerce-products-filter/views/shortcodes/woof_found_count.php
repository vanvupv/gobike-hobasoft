...
?>
<?php if ( $show ) : ?>
	<span class="woof_found_count"><?php echo esc_html( WOOF_REQUEST::isset( 'woof_wp_query_found_posts' ) ? WOOF_REQUEST::get( 'woof_wp_query_found_posts' ) : $wp_query->found_posts ); ?></span>
<?php else : ?>
