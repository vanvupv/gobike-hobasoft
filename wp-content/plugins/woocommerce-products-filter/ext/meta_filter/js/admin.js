...
jQuery(
	function ($) {
		...
		$( '.woof_meta_keys_get_input' ).keydown(
			function (e) {
				if (e.keyCode == 13) {
...
jQuery( "#woof_meta_list" ).sortable(
	{
		update: function (event, ui) {
			woof_sort_order = [];
			jQuery.each(
				jQuery( '#woof_meta_list' ).children( 'li' ),
